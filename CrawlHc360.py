...
# 这个curl方法是从zero那里扒过来的。http://www.seoqx.com/post/341
    ...
    def hc360leimu(self, cppagehtml):
        hc360leimu_data = []

        hc360ssoup = BeautifulSoup(cppagehtml, "lxml")
        hc360sszqsjhtml = hc360ssoup.select(".floor_c_con dl dd a")
        for hc360leimulist in hc360sszqsjhtml:
            hc360leimu_data.append(hc360leimulist.string)
            
        return hc360leimu_data
